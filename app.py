...
from db_helpers import df_query_db, find_donees, get_db, highest_mp_donations, highest_mp_donors, highest_paying_donors, query_db
...
def summary():
    ...
    search_name = clean_name(top_mps[0]['entityName'])
